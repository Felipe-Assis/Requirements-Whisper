label scene_14_discussao_arquitetura:
    ...
    # Passagem de tempo para mostrar imersão técnica
    ...
    show developer_project thinking at left_zoom
    developer_project "Vamos anotar todas as decisões no nosso repositório, para qualquer um consultar depois. Transparência evita conflitos no futuro."
    hide diagrama
