label scene_20_deploy_final:
    ...
    developer_quality "Vamos passar pelo checklist final juntos!"
    ...
    menu:
        ...
        "Sim, revisamos e está no Wiki da equipe.":
            ...
            developer_quality "Ótimo! Isso ajuda até quem chegar na equipe depois."
            hide developer_quality
        "Tem coisa solta no drive ainda...":
            show developer_quality thinking at right_zoom
            developer_quality "Cuidado! Documentação espalhada é receita para confusão no futuro."
            hide developer_quality
    ...
    menu:
        ...
        "Sim, cobertura acima de 85\% e sem falhas.":
            ...
            developer_test "Maravilha! Deploy seguro começa em teste bem feito."
            hide developer_test
        "Ficaram alguns testes quebrando, mas nada grave.":
            show developer_test thinking at right_zoom
            developer_test "Fique atento! Pequenos erros podem crescer lá na frente."
            hide developer_test
    ...
    menu:
        ...
        "Sim, já salvei o backup em nuvem e local.":
            ...
            developer_project "Responsabilidade é tudo! Melhor prevenir do que perder dados."
            hide developer_project
        "Ainda não, mas vou fazer agora.":
            show developer_project serious at right_zoom
            developer_project "Nunca deixe para depois! Backup salva projetos e empregos."
            hide developer_project

    # Pausa para café antes do deploy
    play sound "audio/xicara_cafe.ogg"
    scene bg copa_empresa_tarde
    with dissolve
    ...
    developer_quality "Café de deploy é tradição!"
    show developer_test enthusiastic at center_zoom
    developer_test "Só não derruba no notebook, hein!"
    hide developer_ai
    hide developer_quality
    hide developer_test
    ...
    menu:
        ...
        "Servidor próprio, controle total sobre tudo.":
            ...
            developer_coding "Gosto! Se bem configurado, é seguro. Só lembre de atualizar tudo sempre."
            hide developer_coding
        "Nuvem, mais flexibilidade para crescer e menos dor de cabeça com hardware.":
            show developer_project positive at right_zoom
            developer_project "Ótima escolha para um sistema escalável. Só fique de olho no billing!"
            hide developer_project
        "Docker, CI/CD e tudo automatizado, mirando o futuro!":
            show developer_ai enthusiastic at center_zoom
            developer_ai "Amo! Menos dependência, mais agilidade — e menos 'funciona só na minha máquina'!"
            hide developer_ai
    ...
    "{i}O time troca olhares e sorri, sentindo a pressão e a responsabilidade do momento.{/i}"
    ...
    menu:
        ...
        "Identifico vazamento de memória e otimizo a função.":
            show developer_coding positive at left_zoom
            developer_coding "Mandou bem! Resolver esse tipo de problema rápido é sinal de desenvolvedor experiente."
            hide developer_coding
        "Divido a tarefa com [NOME_DEVELOPER_AI] e [NOME_DEVELOPER_PROJECT] para achar o gargalo.":
            show developer_ai positive at center_zoom
            show developer_project positive at right_zoom
            developer_ai "Em equipe vai mais rápido! Já rodando scripts de profiling."
            developer_project "Localizei uma query lenta, otimizando agora."
            hide developer_ai
            hide developer_project
        "Rodo um script de rollback para evitar downtime e aviso a todos.":
            show developer_quality positive at right_zoom
            developer_quality "Ótima decisão! Mais vale um sistema seguro do que um deploy apressado."
            hide developer_quality
